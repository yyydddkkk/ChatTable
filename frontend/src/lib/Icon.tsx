...
const icons: Record<string, React.ReactNode> = {
  ...
  sparkles: <><path d="M12 3L13.5 8.5L19 10L13.5 11.5L12 17L10.5 11.5L5 10L10.5 8.5L12 3Z"/><path d="M5 3L5.8 5.2L8 6L5.8 6.8L5 9L4.2 6.8L2 6L4.2 5.2L5 3Z"/><path d="M19 13L19.8 15.2L22 16L19.8 16.8L19 19L18.2 16.8L16 16L18.2 15.2L19 13Z"/></>,
};

export const Icon: FC<IconProps> = ({ name, size = 20, className = '', style = {} }) => {
